...
def main(subject_id_test):
    ...
    joblib.dump(scaler, f'{SAVE_MODEL_DIR}/{NAME_DATASET}/Model/StandardScaler_{subject_id_test}_{subject_id_validate}.joblib')
    ...
    for epoch in range(MAX_EPOCH):
        ...
        if total_loss_val < min_loss - 0.001:
            ...
            torch.save({'epoch': epoch, 
                        ...
                        f"{SAVE_MODEL_DIR}/{NAME_DATASET}/Model/{MODEL_NAME}_{subject_id_test}_{subject_id_validate}.pth.tar")
        ...
        logging(str_info+'\n', 
                f'{SAVE_MODEL_DIR}/{NAME_DATASET}/Log/{MODEL_NAME}_{subject_id_test}_{subjext_id_validate}.txt', 
                False)
    ...
    #Test
    modelCheckpoint = torch.load(f"{SAVE_MODEL_DIR}/{NAME_DATASET}/Model/{MODEL_NAME}_{subject_id_test}_{subjext_id_validate}.pth.tar")
    ...
    logging(test_info, f'{SAVE_MODEL_DIR}/{NAME_DATASET}/Log/Test_{MODEL_NAME}_{subject_id_test}.txt', True)
